...
const Profilecomponent = () => {
  ...
  const fetchTargetUserData = async () => {
    ...
    const response = await getTargetUser({
            ...
            <div className="profile-row">
              <div className="profile-sidebar">
                <div className="account-settings-links">
                  <Link
                    className="account-settings-link active"
                  ...
                  <Link className="account-settings-link" to={"/add category"}>
                    Add Category
                  </Link>
                  <Link className="account-settings-link">Messages</Link>
                </div>
              </div>
                  ...
                  <div className="profile-tab active" id="account-general">
                    <div className="profile-media">
                      ...
                      <div className="profile-media-body">
                        ...
                        <button
                          type="button"
                          className="btn-default md-btn-flat"
                        >
                          Reset
                        </button>
                      </div>
                    ...
                    <div className="actions-btn">
                      ...
                      {role !== "admin" && (
                        <button onClick={handelDelet} className="delete-btn">
                          {isDelLoading ? "Loading..." : " Delete Account"}
                        </button>
                      )}
                    </div>
            ...
            <div className="profile-row">
              <div className="profile-sidebar">
                <div className="account-settings-links">
                  ...
                  <Link className="account-settings-link" to={"/add Peoducts"}>
                    Add Products
                  </Link>
                  <Link className="account-settings-link" to={"/products List"}>
                    List Products
                  </Link>

                  <Link className="account-settings-link">Orders</Link>
